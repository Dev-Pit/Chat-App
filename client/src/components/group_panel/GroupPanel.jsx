  ...
  return (
    <section className="w-[40%] flex flex-col border-r-1 border-gray-200">
      <div className="w-full flex justify-between items-center gap-1 py-1 ">
        <h2 className="text-2xl font-black m-3 flex items-center gap-1"><HiUserGroup/> Groups</h2>
      ...
      <div className="relative h-[8%]  mb-2">
        ...
        <div className="absolute bottom-0 w-full ">
          <div className="flex justify-center items-center h-full">
            <button className="flex  mx-1 justify-center items-center gap-1 bg-red-100 text-red-700 hover:bg-red-700 hover:text-white">
              <CgLogOut />
              Logout
            </button>
          </div>
